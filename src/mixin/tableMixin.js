...
const tableMixin = {
  ...
  methods: {
    ...
    //多选
    tableMixin_handleSelectionChange(val) {
      this.tableMixin_multipleSelection = val;
      console.log(this.tableMixin_multipleSelection);
    },
    /**
     * 重置分页
     */
